...
6. For a wide change, split the investigation into independent risk angles when the environment supports parallel workers. Otherwise inspect the angles sequentially. Merge duplicate findings and preserve disagreements.
